<html lang="en-US">
 <head>
  <title>Habboquest - Rare Crates</title>
  <meta charset="utf-8" />
  ...
  <meta property="og:title" content="habboquest - Rare Crates" />
 ...
 <div class="habboquest-nav">
  ...
  <?php include $_SERVER['DOCUMENT_ROOT']."/habboquest_app/habboquest_backend/habboquest_plugins/habboquest_plugins_page/plugin.buyRareCrate.php"; ?>
  <?php
    if (!empty($habboquestCrateError)){ echo "<div class='habboquest-cms-error'><div class='habboquest-nav-container'>&nbsp;&nbsp;<i style='font-size: 19px;' class='fa fa-triangle-exclamation'></i> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$habboquestCrateError</div></div>"; }
  ?>
    ...
    <div class="habboquest-content-grid-a-1">
     <div class="habboquest-crate-common">
      <div style="margin-left: 25px; margin-top: 20px; width: 225px; display: inline-block;">
       Common Crate - 25 points<br><br>
       Rare Furni:<br>
       Gold Dragon 1/100 Chance<br>
       Petal Patch 10/100 Chance<br>
       Many Many More...
      </div>
      <div style="display: inline-block; width: 225px; padding-left: 25px;">
       Currencys: <br>
       5000 Credits 25/100 Chance
       100 Diamonds 20/100 Chance
       Many Many More...
      </div>
      <form style="display: inline-block;" method='POST'>
       <button style="display: inline-block; width: 115px; position: absolute; margin-top: -85px; margin-left: 49px;" type='submit' name='habboquestCommonCrate'>Buy <br>Crate</button>
      </form>
     </div>
     <div class="habboquest-crate-uncommon">
      <div style="margin-left: 25px; margin-top: 20px; width: 225px; display: inline-block;">
       Uncommon Crate - 125 points<br><br>
       Rare Furni:<br>
       Gold Ice Cream 2/100 Chance<br>
       Duck Holo 15/100 Chance<br>
       Many Many More...
      </div>
      <div style="display: inline-block; width: 225px; padding-left: 25px;">
       Currencys: <br>
       7500 Credits 35/100 Chance
       175 Diamonds 25/100 Chance
       Many Many More...
      </div>
      <form style="display: inline-block;" method='POST'>
       <button style="display: inline-block; width: 115px; position: absolute; margin-top: -85px; margin-left: 49px;" type='submit' name='habboquestUncommonCrate'>Buy <br>Crate</button>
      </form>
     </div>
     <div class="habboquest-crate-rare">
      <div style="margin-left: 25px; margin-top: 20px; width: 225px; display: inline-block;">
       Rare Crate - 225 points<br><br>
       Rare Furni:<br>
       Gold Laser 3/100 Chance<br>
       Heart Holo 25/100 Chance<br>
       Many Many More...
      </div>
      <div style="display: inline-block; width: 225px; padding-left: 25px;">
       Currencys: <br>
       15000 Credits 45/100 Chance
       300 Diamonds 30/100 Chance
       Many Many More...
      </div>
      <form style="display: inline-block;" method='POST'>
       <button style="display: inline-block; width: 115px; position: absolute; margin-top: -85px; margin-left: 49px;" type='submit' name='habboquestRareCrate'>Buy <br>Crate</button>
      </form>
     </div>
     <div class="habboquest-crate-ultrarare">
      <div style="margin-left: 25px; margin-top: 20px; width: 225px; display: inline-block;">
       Ultra Rare Crate - 325 points<br><br>
       Rare Furni:<br>
       Dino Egg 5/100 Chance<br>
       Dj Deck 10/100 Chance<br>
       Many Many More...
      </div>
      <div style="display: inline-block; width: 225px; padding-left: 25px;">
       Currencys: <br>
       25000 Credits 60/100 Chance
       500 Diamonds 35/100 Chance
       Many Many More...
      </div>
      <form style="display: inline-block;" method='POST'>
       <button style="display: inline-block; width: 115px; position: absolute; margin-top: -85px; margin-left: 49px;" type='submit' name='habboquestUltraRareCrate'>Buy <br>Crate</button>
      </form>
     </div>
