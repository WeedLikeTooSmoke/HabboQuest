<html lang="en-US">
 <head>
  <title>Habboquest - Leaderboard</title>
  <meta charset="utf-8" />
  ...
  <meta property="og:title" content="habboquest - Leaderboard" />
  ...
  <div class="habboquest-content">
   <div class="habboquest-content-grid">
    <div class="habboquest-content-grid-a-1">
     <div class="habboquest-leaderboard">
      <?php include $_SERVER['DOCUMENT_ROOT']."/habboquest_app/habboquest_backend/habboquest_plugins/habboquest_plugins_page/plugin.leaderboard.credits.php"; ?> 
     </div>
     <div class="habboquest-leaderboard">
      <?php include $_SERVER['DOCUMENT_ROOT']."/habboquest_app/habboquest_backend/habboquest_plugins/habboquest_plugins_page/plugin.leaderboard.pixels.php"; ?> 
     </div>
     <div class="habboquest-leaderboard">
      <?php include $_SERVER['DOCUMENT_ROOT']."/habboquest_app/habboquest_backend/habboquest_plugins/habboquest_plugins_page/plugin.leaderboard.diamonds.php"; ?> 
     </div>
