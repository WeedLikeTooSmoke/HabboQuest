<html lang="en-US">
 <head>
  <title>Habboquest - Inventory</title>
  <meta charset="utf-8" />
  ...
  <meta property="og:title" content="habboquest - inventory" />
  ...
  <div class="habboquest-content">
   <div class="habboquest-content-grid">
    <div class="habboquest-content-grid-a-1">
     <div class="habboquest-inventory">
      <?php include $_SERVER['DOCUMENT_ROOT']."/habboquest_app/habboquest_backend/habboquest_plugins/habboquest_plugins_page/plugin.inventory.php"; ?>
     </div>
     <div class="habboquest-badges">
      <?php include $_SERVER['DOCUMENT_ROOT']."/habboquest_app/habboquest_backend/habboquest_plugins/habboquest_plugins_page/plugin.inventory.badges.php"; ?> 
     </div>
     <div class="habboquest-inventory">
      <?php include $_SERVER['DOCUMENT_ROOT']."/habboquest_app/habboquest_backend/habboquest_plugins/habboquest_plugins_page/plugin.inventoryLotteryTickets.php"; ?>
     </div>
     <div class="habboquest-inventory">
      <?php include $_SERVER['DOCUMENT_ROOT']."/habboquest_app/habboquest_backend/habboquest_plugins/habboquest_plugins_page/plugin.inventoryCrates.php"; ?>
     </div>
