<?php
if (isset($_GET['id'])) {
  if ($_SERVER['REQUEST_URI'] == "/news/".$_GET['id']) {
...
<html lang="en-US">
 <head>
  <title>Habboquest - <?php if (isset($_GET['id'])) { echo $news['news_title']; } else { echo "News"; } ?></title>
  <meta charset="utf-8" />
  ...
  <meta property="og:title" content="habboquest - News" />
   ...
   <div class="habboquest-content-grid">
    <div class="habboquest-content-grid-a-1">
      ...
      if ($_SERVER['REQUEST_URI'] == "/news") {
        echo "<div class='habboquest-news-links'>";
        include $_SERVER['DOCUMENT_ROOT']."/habboquest_app/habboquest_backend/habboquest_plugins/habboquest_plugins_page/plugin.newsLinks.php";
        echo "</div>";
      } else {
        echo "<div class='habboquest-news-main'>";
        include $_SERVER['DOCUMENT_ROOT']."/habboquest_app/habboquest_backend/habboquest_plugins/habboquest_plugins_page/plugin.newsMain.php";
        echo "</div>";
      }
      ?>
