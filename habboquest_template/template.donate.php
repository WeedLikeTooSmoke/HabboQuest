<html lang="en-US">
 <head>
  ...
  <meta property="og:title" content="habboquest - Donate" />
  ...
  <div class="habboquest-content">
   <div class="habboquest-content-grid">
    <div class="habboquest-content-grid-a-1">
     <div class="habboquest-staff-donations">
      <?php include $_SERVER['DOCUMENT_ROOT']."/habboquest_app/habboquest_backend/habboquest_plugins/habboquest_plugins_page/plugin.staffDonate.php"; ?>
     </div>
