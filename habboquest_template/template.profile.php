<html lang="en-US">
 <head>
  <title>Habboquest - <?php echo xss($_GET['username']); ?>('s) Profile </title>
  <meta charset="utf-8" />
   ...
   <div class="habboquest-content-grid">
    ...
    <div class="habboquest-small-user-profile">
      ...
      <div class="habboquest-small-user-profile-grid">
       <div class="habboquest-small-user-profile-grid-a-1">&nbsp; <i class="fa fa-id-badge"></i> &nbsp; &nbsp; &nbsp; <?php echo xss($_GET['username']); ?></div>
       <div class="habboquest-small-user-profile-grid-a-1"></div>
       ...
       <div class="habboquest-small-user-profile-grid-a-1"></div>
       <div class="habboquest-small-user-profile-box">
        <?php include $_SERVER['DOCUMENT_ROOT']."/habboquest_app/habboquest_backend/habboquest_plugins/habboquest_plugins_page/plugin.profileBadges.php"; ?> 
       </div>
      </div>
     </div>
