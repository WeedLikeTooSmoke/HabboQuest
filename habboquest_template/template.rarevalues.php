<html lang="en-US">
 <head>
  <title>Habboquest - Rare Values</title>
  <meta charset="utf-8" />
  ...
  <meta property="og:title" content="habboquest - Rare Values" />
  ...
  <div class="habboquest-content">
   <div class="habboquest-content-grid">
    <div class="habboquest-content-grid-a-1">
     <div class="habboquest-rarevalues">
      <?php include $_SERVER['DOCUMENT_ROOT']."/habboquest_app/habboquest_backend/habboquest_plugins/habboquest_plugins_page/plugin.rarevalues.php"; ?>
     </div>
